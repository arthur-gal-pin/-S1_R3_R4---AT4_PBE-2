...
const pedidoRepository = {
    create: async (pedido: Pedidos, itens_Pedido: ItensPedido[]): Promise<any> => {
        ...
        try {
            ...
            const sqlPed = 'INSERT INTO pedidos (fk_IdCliente, SubTotal, Status) VALUES (?,?,?)';
    ...
    read: async (idCliente?: number, idPedido?: number): Promise<any[]> => {
        let sql = `
            SELECT p.*, i.IdItens_Pedido, i.fk_IdProduto, i.Quantidade, i.Valor
            FROM pedidos p
